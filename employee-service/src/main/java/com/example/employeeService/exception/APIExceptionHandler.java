...
public class APIExceptionHandler {
    ...
    public ResponseEntity<ApiExceptionPayload> handleInvalidBoardSizeException(EmployeeNotFoundException ex) {
    ...
    private FieldErrorPayload processFieldErrors(List<org.springframework.validation.FieldError> fieldErrors) {
